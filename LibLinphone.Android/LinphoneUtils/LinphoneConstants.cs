...
namespace LibLinphone.Android.LinphoneUtils
{
    public struct LinphoneConstants
    {
        ...
        public const float DEFAULT_PLAYBACK_GAIN_2F_DB = 5f;
        public const float DEFAULT_MIC_GAIN_2F_DB = 0f;

        public const float DEFAULT_PLAYBACK_GAIN_IP_DB = 5f;
        public const float DEFAULT_MIC_GAIN_IP_DB = 0f;
    }
}